...
def test_event_type_values() -> None:
    ...
    assert {event_type.value for event_type in EventType} == {
        ...
        "LEARNING_VALIDATED",
        "LEARNING_REJECTED",
        "LEARNING_HUMAN_REVIEW_REQUIRED",
        ...
        "KNOWLEDGE_ENTITY_VERSIONED",
        "KNOWLEDGE_ENTITY_ARCHIVED",
        "KNOWLEDGE_ENTITY_MERGED",
        "KNOWLEDGE_RELATIONSHIP_CREATED",
        "KNOWLEDGE_RELATIONSHIP_VERSIONED",
        ...
        "KNOWLEDGE_PROJECTION_COMPLETED",
